		...
		<div class="div_from_aoto" style="width: auto;">
			<form>
				<div class="control-group">
					...
					<div class="controls">
						<p class=help-block>
							<input class="input_from" type=text placeholder=" 发布人昵称">
							&nbsp;
						</p>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<p class=help-block>
							<select name="s_language_type" id="s_language_type">
				...
				<div class="control-group">
					...
					<div class="controls">
						<p class=help-block>
							<select name="s_contentfirst_type" id="s_contentfirst_type">
				...
				<div class="control-group">
					...
					<div class="controls">
						<p class=help-block>
							<select name="s_contentsecond_type" id="s_contentsecond_type">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="input_from" style="width: 500px; height: 150px;"
							type=text placeholder="问题描述(中文)"></textarea>
						&nbsp;
						<textarea class="input_from" style="width: 500px; height: 150px;"
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="input_from" style="width: 500px; height: 200px;"
							type=text placeholder="推荐答案及描述(中文)"></textarea>
						&nbsp;
						<textarea class="input_from" style="width: 500px; height: 200px;"
