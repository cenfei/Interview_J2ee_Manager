...
+"		<input type='hidden' name='superUrl' id='fileName"+rowID+"' value='UploadHeadPic/logo.png' />"
;
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div>
							...
							<img alt="" src="UploadHeadPic/logo.png" id="img0"
								style="width: 150px; height: 150px;" />
							<input type="hidden" name="headPicUrl" id="fileName0" />
