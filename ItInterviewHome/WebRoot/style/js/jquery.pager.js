...
(function($) {
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        ...
        var $pager = $('<ul class="pagination pagination-activity"></ul>');
        ...
        $pager.append(renderButton('&laquo;', pagenumber, pagecount, buttonClickCallback));
        ...
        for (var page = startPoint; page <= endPoint; page++) {
            ...
            page == pagenumber ? currentButton.addClass('active') : currentButton.click(function() {
            	buttonClickCallback(+$(this).find("span").text());
            });
        ...
        $pager.append(renderButton('&raquo;', pagenumber, pagecount, buttonClickCallback));
    ...
    function renderButton(buttonLabel, pagenumber, pagecount, buttonClickCallback) {
        ...
        if (buttonLabel == "第一页" || buttonLabel == "&laquo;") {
